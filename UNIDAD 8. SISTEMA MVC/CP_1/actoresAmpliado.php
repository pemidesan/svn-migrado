...
<html lang="es">
    ...
    <body>
        ...
        <main>
            <h1>Actores Juego de Tronos por Temporada</h1>
            <?php
                ...
                {
                    $consulta = "select distinct episode, name, serie_name from season_ep where episode= ".$_POST["episodio"];                    
                    $resultado = $juegoTronos->lectura($consulta);
