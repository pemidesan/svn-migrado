...
<html lang="es">
    ...
    <body>
        ...
        <main>            
            <?php
                echo "<h1>Partidos jugados: ".$_POST['equipo_local']." VS ".$_POST['equipo_visitante']."<br>";
                echo "Temporada ".$_POST['temporada']."</h1>";                
                $nba = new dbV3("localhost","pemidesan","S1nPerd0n","nba");

                if ($nba->conexion())
                {
                    $consulta = "select * from partidos where equipo_local='".$_POST['equipo_local']."' and equipo_visitante='".$_POST['equipo_visitante'].
                                "' and temporada='".$_POST['temporada']."'";       
